...
API_ID = int(environ.get('API_ID', '19890227'))
API_HASH = environ.get('API_HASH', 'ad2685e918be5a89c31e991448262e63')
BOT_TOKEN = environ.get('BOT_TOKEN', "5609512195:AAE3L6_3v_HEWGcqMZGnvo1CaFOvJLyf7GQ")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/2846df4560e052325504e.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001787207236').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001754375414')
auth_grp = environ.get('AUTH_GROUP', '-1001497763152')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/dummypr')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+KuDplZMSllI2NjZh')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/kannjj')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001720103499))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001810806290))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/cynitebackup')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/howyuse')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001579047604))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001579047604))
